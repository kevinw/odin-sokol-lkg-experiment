package microui_atlas;

import mu "../../microui"

ATLAS_WHITE :: mu.Icon.Max;
ATLAS_FONT :: cast(mu.Icon)(cast(int)mu.Icon.Max + 1);
...
atlas := [200]mu.Rect {
    mu.Icon.Close = {88, 68, 16, 16},
    mu.Icon.Check = { 0, 0, 18, 18 },
    mu.Icon.Expanded = { 118, 68, 7, 5 },
    mu.Icon.Collapsed = { 113, 68, 5, 7 },
    //mu.Icon.Resize = { 104, 68, 9, 9 },
...
init :: proc() {
    ...
    atlas[ATLAS_FONT+cast(mu.Icon)35] = { 34, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)36] = { 28, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)37] = { 58, 0, 9, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)38] = { 103, 0, 8, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)39] = { 86, 68, 2, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)40] = { 42, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)41] = { 45, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)42] = { 34, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)43] = { 40, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)44] = { 48, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)45] = { 51, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)46] = { 54, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)47] = { 124, 34, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)48] = { 46, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)49] = { 52, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)50] = { 58, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)51] = { 64, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)52] = { 70, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)53] = { 76, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)54] = { 82, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)55] = { 88, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)56] = { 94, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)57] = { 100, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)58] = { 57, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)59] = { 60, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)60] = { 106, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)61] = { 112, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)62] = { 118, 34, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)63] = { 119, 51, 5, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)64] = { 18, 0, 10, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)65] = { 41, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)66] = { 48, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)67] = { 55, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)68] = { 111, 0, 8, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)69] = { 0, 35, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)70] = { 6, 35, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)71] = { 119, 0, 8, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)72] = { 18, 17, 8, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)73] = { 63, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)74] = { 66, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)75] = { 62, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)76] = { 12, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)77] = { 28, 0, 10, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)78] = { 67, 0, 9, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)79] = { 76, 0, 9, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)80] = { 69, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)81] = { 85, 0, 9, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)82] = { 76, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)83] = { 18, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)84] = { 24, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)85] = { 26, 17, 8, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)86] = { 83, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)87] = { 38, 0, 10, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)88] = { 90, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)89] = { 30, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)90] = { 36, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)91] = { 69, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)92] = { 124, 51, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)93] = { 72, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)94] = { 42, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)95] = { 15, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)96] = { 48, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)97] = { 54, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)98] = { 97, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)99] = { 0, 52, 5, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)100] = { 104, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)101] = { 60, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)102] = { 19, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)103] = { 66, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)104] = { 111, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)105] = { 75, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)106] = { 78, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)107] = { 72, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)108] = { 81, 68, 3, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)109] = { 48, 0, 10, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)110] = { 118, 17, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)111] = { 0, 18, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)112] = { 7, 18, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)113] = { 14, 34, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)114] = { 23, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)115] = { 5, 52, 5, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)116] = { 27, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)117] = { 21, 34, 7, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)118] = { 78, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)119] = { 94, 0, 9, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)120] = { 84, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)121] = { 90, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)122] = { 10, 68, 5, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)123] = { 31, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)124] = { 96, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)125] = { 35, 68, 4, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)126] = { 102, 51, 6, 17 };
    atlas[ATLAS_FONT+cast(mu.Icon)127] = { 108, 51, 6, 17 };
};
